...
//默认记录评论 Cookie
add_action('set_comment_cookies','dahuzi_set_cookies',10,3);
function dahuzi_set_cookies( $comment, $user, $cookies_consent){
	$cookies_consent = true;
	wp_set_comment_cookies($comment, $user, $cookies_consent);
}

//评论列表
function dahuzi_theme_list_comments($comment, $args, $depth) {
