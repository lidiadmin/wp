  ...
  <div class="carousel-inner" role="listbox">
    ...
    <div class="carousel-item<?php if($i == 1){?> active<?php }?>">
      <?php if ( wp_is_mobile() && $value['banner_img_mobile']['url'] ){ ?>
            <img src="<?php echo $value['banner_img_mobile']['url'];?>" alt="<?php echo get_post_meta( $value['banner_img']['id'], '_wp_attachment_image_alt', true );?>" class="slide-image">
      <?php }else { ?>
            <img src="<?php echo $value['banner_img']['url'];?>" alt="<?php echo get_post_meta( $value['banner_img']['id'], '_wp_attachment_image_alt', true );?>" class="slide-image">
      <?php } ?>
      ...
      <div class="col-lg-<?php echo $total_block;?>">
        <div class="feature-item">
          ...
          <div class="icon-box" style="width:<?php echo $value['block_img_px'];?>%;">
            <img src="<?php echo $value['block_img']['url'];?>" alt="<?php echo get_post_meta( $value['block_img']['id'], '_wp_attachment_image_alt', true );?>">
          </div>
          <?php }?>
