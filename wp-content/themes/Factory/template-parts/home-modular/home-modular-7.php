...
$modular_col_post_num = $id['modular7_col_post_num'];?>
<section class="blog-section modular_display_<?php echo $id['modular_display'];?> <?php if( $id['modular_bg_f9'] ){ echo 'bg-f9'; }?>">
<div class="container">
  <div class="row">
