...
?>
<section class="projects-section over-layer-white parallax-bg modular_display_<?php echo $id['modular_display'];?>" style="background-image:url(<?php echo $modular_4_bg;?>);" data-type="parallax" data-speed="5">
<div class="container">
	<div class="row">
    ...
    $s = 1;
    foreach ($modular_category as $cat=>$catid ){?>
	<script type="text/javascript">$(document).ready(function() {$(".owl-<?php echo $s+1;?>").owlCarousel({loop:true,autoplay: 5000,autoplayHoverPause:false,smartSpeed: 700,items: 3,margin:30,dots: true,nav:true,navText: ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsive:{0:{items:1},480:{items:1},600:{items:1},800:{items:2},1024:{items:3},1200:{items:3}}});});</script>
	...
	<script type="text/javascript">$(document).ready(function() {$("#projects_carousel").owlCarousel({loop:true,autoplay: 5000,autoplayHoverPause:false,smartSpeed: 700,items: 3,margin:30,dots: true,nav:true,navText: ['<i class="fa fa-angle-left"></i>','<i class="fa fa-angle-right"></i>'],responsive:{0:{items:1},480:{items:1},600:{items:1},800:{items:2},1024:{items:3},1200:{items:3}}});});</script>
	<div class="row">
		<div class="col-md-12">
