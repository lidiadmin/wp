<div class="mb-4 mt-5">
	<h4 class="comments-title"><?php echo xintheme('contact_title') ?: '在线留言';?></h4>
	...
	<div class="form-row">
		...
		<div class="form-group col-md-12">
			<div class="contact-textarea">
				<textarea class="form-control" rows="6" placeholder="<?php echo xintheme('contact_textarea') ?: '请输入留言内容...';?>" id="message" name="message" required></textarea>
				<input type="hidden" name="current_url" id="current_url" value="<?php echo home_url(add_query_arg(array()));?>">
				<input type="hidden" name="action" value="dahuzi_contact_ajax">
				<div id="form-messages"></div>
				<button id="submit_message" class="btn btn-theme mt-4 mb-4" type="submit"><?php echo xintheme('contact_button') ?: '提交留言';?></button>
			</div>
		</div>
	</div>
</form>
